...
export function Applications() {
  ...
  return (
    <section id="applications" className="py-24 bg-gradient-to-b from-[#161616] to-[#0a0a0a]" ref={ref}>
        ...
        >
          {applications.map((app, index) => (
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
            >
              <Card className={`p-8 bg-gradient-to-br ${app.color} border-white/10 backdrop-blur-sm transition-all duration-300 group h-full`}>
